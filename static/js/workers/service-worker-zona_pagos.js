/**
 * D'Antojitos — Service Worker: ZONA DE PAGOS / FACTURAS v4
 * Cubre: /gestionar_facturas_page, facturas, historial de pagos,
 *        exportación PDF — sin caché de operaciones financieras.
 */
importScripts('/static/js/workers/sw-core.js');

const CACHE_NAME = 'dantojitos-pagos-v4';
...
/* Operaciones financieras — nunca desde caché */
const NEVER_CACHE = [
    '/procesar_pago',
    '/confirmar_pago',
    '/webhook_pago',
...
self.addEventListener('fetch', e => {
    ...
    /* Operaciones financieras — siempre a red */
