"""
Sistema de logros — 231 logros organizados por módulo y rol.
11 módulos × 7 logros × 3 roles = 231.
"""
...
_INICIO = [
    ...
    _l("inicio","ini_a5","Pilar del sistema","30 visitas a la página de inicio","🏆","epico",60,A),
...
_CATALOGO = [
    ...
    _l("catalogo","cat_c4","Connoisseur","30 visitas al catálogo","🍰","raro",25,C),
    ...
    _l("catalogo","cat_v4","Curador del catálogo","30 visitas al catálogo","🎨","raro",25,V),
    ...
    _l("catalogo","cat_a4","Auditor de catálogo","30 visitas al catálogo","📊","raro",25,A),
    _l("catalogo","cat_a5","Catálogo robusto","20 o más productos activos en el sistema","📦","raro",30,A),
    _l("catalogo","cat_a6","Gran inventario","50 o más productos activos en el sistema","🏪","epico",60,A),
...
_CARRITO = [
    ...
    _l("carrito","cart_c4","Gran pedido","Carrito con 10 o más productos","🎁","raro",25,C),
    ...
    _l("carrito","cart_v4","50 ventas del sistema","50 pedidos totales en la plataforma","🏪","raro",25,V),
    ...
    _l("carrito","cart_a4","Economía activa","50 pedidos totales en la plataforma","💹","raro",25,A),
    _l("carrito","cart_a5","Crecimiento sólido","100 pedidos totales en la plataforma","📈","raro",30,A),
    _l("carrito","cart_a6","Gran plataforma","500 pedidos totales en la plataforma","🌟","epico",60,A),
...
_PAGOS = [
    ...
    _l("pagos","pago_c4","Cliente frecuente","10 pedidos realizados","🥇","raro",50,C),
    ...
    _l("pagos","pago_v4","50K en el sistema","$50,000 COP en ventas totales del sistema","💸","raro",25,V),
    ...
    _l("pagos","pago_a4","Plataforma financiera","$500,000 COP en ventas totales del sistema","💸","raro",35,A),
    _l("pagos","pago_a5","Gran negocio","$2,000,000 COP en ventas totales del sistema","🏆","epico",70,A),
    _l("pagos","pago_a6","Empresa sólida","$10,000,000 COP en ventas totales del sistema","👑","legendario",150,A),
...
_SUGERENCIAS = [
    ...
    _l("sugerencias","sug_c4","Influencer del sabor","20 sugerencias publicadas","🌟","epico",60,C),
    ...
    _l("sugerencias","sug_v4","Orientado al cliente","30 visitas al módulo de sugerencias","🎯","raro",25,V),
    ...
    _l("sugerencias","sug_a4","Plataforma abierta","10 sugerencias totales en el sistema","💬","raro",25,A),
    _l("sugerencias","sug_a5","Comunidad activa","50 sugerencias totales en el sistema","📣","raro",35,A),
    _l("sugerencias","sug_a6","Gran comunidad","200 sugerencias totales en el sistema","🌟","epico",70,A),
...
_MENSAJES = [
    ...
    _l("mensajes","msg_c2","Comunicativo","10 mensajes privados enviados","💬","comun",20,C),
    _l("mensajes","msg_c3","Siempre en contacto","25 mensajes privados enviados","📱","raro",35,C),
    _l("mensajes","msg_c4","Conversador","50 mensajes privados enviados","🗣️","raro",50,C),
    _l("mensajes","msg_c5","Networker","100 mensajes privados enviados","📡","epico",80,C),
    _l("mensajes","msg_c6","Una imagen vale más","Adjuntaste una imagen en el chat","📷","comun",15,C),
    _l("mensajes","msg_c7","Comunicador élite","200 mensajes privados enviados","👑","legendario",150,C),
    # Vendedores
    _l("mensajes","msg_v1","Atención al cliente","Enviaste tu primer mensaje privado","📩","comun",10,V),
    _l("mensajes","msg_v2","Soporte activo","10 mensajes privados enviados","💬","comun",20,V),
    _l("mensajes","msg_v3","Servicio al cliente","25 mensajes privados enviados","🎧","raro",35,V),
    _l("mensajes","msg_v4","Soporte dedicado","50 mensajes privados enviados","🏅","raro",50,V),
    _l("mensajes","msg_v5","Helpdesk estrella","100 mensajes privados enviados","🌟","epico",80,V),
    _l("mensajes","msg_v6","Imagen en chat","Adjuntaste una imagen en el chat","📷","comun",15,V),
    _l("mensajes","msg_v7","Comunicador profesional","200 mensajes privados enviados","👑","legendario",120,V),
    # Admins
    _l("mensajes","msg_a1","Supervisor de mensajes","Primera visita al módulo de mensajes","📊","comun",5,A),
    _l("mensajes","msg_a2","Moderador de chat","5 visitas al módulo de mensajes","🔧","comun",10,A),
    _l("mensajes","msg_a3","Control de comunicación","15 visitas al módulo de mensajes","🛡️","comun",15,A),
    _l("mensajes","msg_a4","Mensajería activa","50 mensajes totales en el sistema","💬","raro",25,A),
    _l("mensajes","msg_a5","Comunidad conectada","200 mensajes totales en el sistema","📡","raro",35,A),
    _l("mensajes","msg_a6","Gran comunidad activa","500 mensajes totales en el sistema","🌟","epico",60,A),
    _l("mensajes","msg_a7","Red de comunicación","1000 mensajes totales en el sistema","🏆","legendario",120,A),
]

# ══════════════════════════════════════════════════════
# 7 · PERFIL (prf_)  — 21 logros
# ══════════════════════════════════════════════════════
_PERFIL = [
    # Clientes
    ...
    _l("perfil","prf_c5","Cara conocida","Subiste tu foto de perfil","📸","comun",15,C),
    _l("perfil","prf_c6","Perfil al 100%","Completaste todos los campos de tu perfil","✅","raro",30,C),
    _l("perfil","prf_c7","Veterano","Llevas más de 30 días registrado","🌟","raro",25,C),
    # Vendedores
    ...
    _l("perfil","prf_v4","Foto profesional","Subiste tu foto de perfil","📸","comun",15,V),
    _l("perfil","prf_v5","Perfil de vendedor","Completaste todos los campos de tu perfil","✅","raro",30,V),
    _l("perfil","prf_v6","Cumpleaños registrado","Registraste tu fecha de cumpleaños","🎂","comun",15,V),
    _l("perfil","prf_v7","Veterano del negocio","Llevas más de 30 días registrado","🌟","raro",25,V),
    # Admins
    ...
    _l("perfil","prf_a4","Foto oficial","Subiste tu foto de perfil","📸","comun",15,A),
    _l("perfil","prf_a5","Perfil administrativo","Completaste todos los campos de tu perfil","✅","raro",30,A),
    _l("perfil","prf_a6","Cumpleaños anotado","Registraste tu fecha de cumpleaños","🎂","comun",15,A),
    _l("perfil","prf_a7","Administrador veterano","Llevas más de 30 días registrado","🌟","raro",30,A),
]

# ══════════════════════════════════════════════════════
# 8 · HISTORIAL & FACTURAS (fac_)  — 21 logros
# ══════════════════════════════════════════════════════
_HISTORIAL = [
    # Clientes
    _l("historial","fac_c1","Primera factura","Recibiste tu primera factura","🧾","comun",15,C),
    _l("historial","fac_c2","Historial activo","3 facturas generadas","📂","comun",20,C),
    _l("historial","fac_c3","Comprador registrado","5 facturas generadas","📋","raro",30,C),
    _l("historial","fac_c4","Historial completo","10 facturas generadas","📊","raro",45,C),
    _l("historial","fac_c5","Cliente VIP","20 facturas generadas","💎","epico",70,C),
    _l("historial","fac_c6","Dulce inversión","Gastaste más de $20,000 COP en total","💰","comun",20,C),
    _l("historial","fac_c7","Rey del dulce","Gastaste más de $500,000 COP en total","🤑","legendario",150,C),
    # Vendedores
    _l("historial","fac_v1","Gestión de facturas","Primera visita al historial","📊","comun",5,V),
    _l("historial","fac_v2","Seguimiento activo","5 visitas al historial","📋","comun",10,V),
    _l("historial","fac_v3","Analista financiero","15 visitas al historial","💰","comun",15,V),
    _l("historial","fac_v4","10 facturas en el sistema","10 facturas totales en el sistema","📂","raro",25,V),
    _l("historial","fac_v5","50 facturas en el sistema","50 facturas totales en el sistema","📈","raro",35,V),
    _l("historial","fac_v6","200 facturas en el sistema","200 facturas totales en el sistema","🌟","epico",65,V),
    _l("historial","fac_v7","500 facturas en el sistema","500 facturas totales en el sistema","🏆","legendario",130,V),
    # Admins
    _l("historial","fac_a1","Supervisor de facturas","Primera visita al historial","📊","comun",5,A),
    _l("historial","fac_a2","Auditor de facturas","5 visitas al historial","🔎","comun",10,A),
    _l("historial","fac_a3","Control fiscal","15 visitas al historial","💼","comun",15,A),
    _l("historial","fac_a4","Facturación activa","10 facturas totales en el sistema","📂","raro",25,A),
    _l("historial","fac_a5","Facturación masiva","50 facturas totales en el sistema","📈","raro",35,A),
    _l("historial","fac_a6","Sistema contable","200 facturas totales en el sistema","🌟","epico",65,A),
    _l("historial","fac_a7","Contabilidad total","500 facturas totales en el sistema","🏆","legendario",130,A),
]

# ══════════════════════════════════════════════════════
# 9 · GESTIÓN DE PRODUCTOS (prod_)  — 21 logros
# ══════════════════════════════════════════════════════
_PRODUCTOS = [
    # Clientes (como exploradores del catálogo de productos)
    ...
    _l("gestion_productos","prod_c3","Variedad es vida","Compraste 3 productos distintos","🌈","comun",15,C),
    _l("gestion_productos","prod_c4","Aventurero del sabor","Compraste 5 productos distintos","🗺️","raro",30,C),
    _l("gestion_productos","prod_c5","Coleccionista de sabores","Compraste 10 productos distintos","🎯","epico",60,C),
    _l("gestion_productos","prod_c6","Siempre hay algo nuevo","Compraste 20 productos distintos","🌟","epico",80,C),
    _l("gestion_productos","prod_c7","Catador maestro","Compraste 30 productos distintos","👑","legendario",130,C),
    # Vendedores
    _l("gestion_productos","prod_v1","Primer producto creado","Creaste tu primer producto","🆕","comun",15,V),
    _l("gestion_productos","prod_v2","Menú en formación","3 visitas a gestión de productos","📝","comun",10,V),
    _l("gestion_productos","prod_v3","Portafolio activo","10 visitas a gestión de productos","📋","comun",15,V),
    _l("gestion_productos","prod_v4","Vendedor completo","30 visitas a gestión de productos","🏪","raro",30,V),
    _l("gestion_productos","prod_v5","Gran catálogo propio","60 visitas a gestión de productos","🌟","epico",60,V),
    _l("gestion_productos","prod_v6","Producto editado","Editaste un producto (acción)","🔧","comun",10,V),
    _l("gestion_productos","prod_v7","Maestro del menú","100 visitas a gestión de productos","🏆","legendario",120,V),
    # Admins
    _l("gestion_productos","prod_a1","Primer producto supervisado","Primera visita a gestión de productos","👁️","comun",5,A),
    _l("gestion_productos","prod_a2","Curador de productos","5 visitas a gestión de productos","📋","comun",10,A),
    _l("gestion_productos","prod_a3","Inspector de calidad","15 visitas a gestión de productos","🔎","comun",15,A),
    _l("gestion_productos","prod_a4","Catálogo supervisado","20 o más productos activos","📦","raro",25,A),
    _l("gestion_productos","prod_a5","Variedad asegurada","50 o más productos activos","🏪","raro",35,A),
    _l("gestion_productos","prod_a6","Gran inventario activo","100 o más productos activos","🌟","epico",70,A),
    _l("gestion_productos","prod_a7","Megatienda activa","200 o más productos activos","🏆","legendario",130,A),
]

# ══════════════════════════════════════════════════════
# 10 · PUBLICIDAD (pub_)  — 21 logros
# ══════════════════════════════════════════════════════
_PUBLICIDAD = [
    # Clientes
    _l("publicidad","pub_c1","Primera promo vista","Primera visita a la sección de publicidad","🎯","comun",5,C),
    _l("publicidad","pub_c2","Fan de las promos","5 visitas a la sección de publicidad","💡","comun",10,C),
    _l("publicidad","pub_c3","Cazador de ofertas","15 visitas a publicidad","🏷️","comun",15,C),
    _l("publicidad","pub_c4","Ofertero empedernido","30 visitas a publicidad","🔥","raro",25,C),
    _l("publicidad","pub_c5","Comprador por anuncio","Compraste en tu primera visita al catálogo","🛒","raro",30,C),
    _l("publicidad","pub_c6","Seguidor de marcas","50 visitas a publicidad","📢","epico",60,C),
    _l("publicidad","pub_c7","Fan total","100 visitas a publicidad","💥","legendario",100,C),
    # Vendedores
    _l("publicidad","pub_v1","Primera publicidad","Creaste tu primera publicidad (acción)","📢","comun",15,V),
    _l("publicidad","pub_v2","Estrategia visual","3 visitas al módulo de publicidad","🎨","comun",10,V),
    _l("publicidad","pub_v3","Campaña activa","10 visitas al módulo de publicidad","📣","comun",15,V),
    _l("publicidad","pub_v4","Publicista activo","30 visitas al módulo de publicidad","🏆","raro",30,V),
    _l("publicidad","pub_v5","Maestro del marketing","60 visitas al módulo de publicidad","🌟","epico",60,V),
    _l("publicidad","pub_v6","Publicidad editada","Editaste una publicidad (acción)","🔧","comun",10,V),
    _l("publicidad","pub_v7","Campaña épica","100 visitas al módulo de publicidad","👑","legendario",120,V),
    # Admins
    _l("publicidad","pub_a1","Gestor de publicidad","Primera visita al módulo de publicidad","📊","comun",5,A),
    _l("publicidad","pub_a2","Supervisor de anuncios","5 visitas al módulo de publicidad","📋","comun",10,A),
    _l("publicidad","pub_a3","Control de campañas","15 visitas al módulo de publicidad","🛡️","comun",15,A),
    _l("publicidad","pub_a4","Plataforma publicitada","1 publicidad activa en el sistema","📢","raro",25,A),
    _l("publicidad","pub_a5","Publicidad activa","5 publicidades en el sistema","📣","raro",35,A),
    _l("publicidad","pub_a6","Gran campaña","10 publicidades en el sistema","🌟","epico",60,A),
    _l("publicidad","pub_a7","Mega campaña","20 publicidades en el sistema","🏆","legendario",120,A),
]

# ══════════════════════════════════════════════════════
# 11 · GESTIÓN DE USUARIOS (usr_)  — 21 logros
# ══════════════════════════════════════════════════════
_USUARIOS = [
    # Clientes
    _l("gestion_usuarios","usr_c1","Cuenta creada","Registraste tu cuenta en D'Antojitos","🎉","comun",10,C),
    _l("gestion_usuarios","usr_c2","Cuenta activa","7 días desde tu registro","📅","comun",15,C),
    _l("gestion_usuarios","usr_c3","Mes completado","30 días registrado","🗓️","raro",30,C),
    _l("gestion_usuarios","usr_c4","Trimestre activo","90 días registrado","⏳","raro",50,C),
    _l("gestion_usuarios","usr_c5","Medio año contigo","180 días registrado","💙","epico",80,C),
    _l("gestion_usuarios","usr_c6","Un año con nosotros","365 días registrado","🏆","legendario",150,C),
    _l("gestion_usuarios","usr_c7","Usuario leal","2 años registrado","👑","legendario",200,C),
    # Vendedores
    _l("gestion_usuarios","usr_v1","Vendedor registrado","Primera semana como vendedor","📅","comun",15,V),
    _l("gestion_usuarios","usr_v2","Vendedor activo","30 días registrado","🗓️","raro",30,V),
    _l("gestion_usuarios","usr_v3","Vendedor establecido","90 días registrado","⏳","raro",50,V),
    _l("gestion_usuarios","usr_v4","Vendedor veterano","180 días registrado","💙","epico",80,V),
    _l("gestion_usuarios","usr_v5","Vendedor del año","365 días registrado","🏆","legendario",150,V),
    _l("gestion_usuarios","usr_v6","Más usuarios","10 clientes registrados en el sistema","👥","comun",10,V),
    _l("gestion_usuarios","usr_v7","Gran comunidad de clientes","50 clientes en el sistema","🌟","raro",30,V),
    # Admins
    _l("gestion_usuarios","usr_a1","Primera gestión","Primera visita a gestión de usuarios","👁️","comun",5,A),
    _l("gestion_usuarios","usr_a2","Moderador","5 visitas a gestión de usuarios","📋","comun",10,A),
    _l("gestion_usuarios","usr_a3","Administrador activo","15 visitas a gestión de usuarios","🛡️","comun",15,A),
    _l("gestion_usuarios","usr_a4","10 usuarios registrados","10 usuarios en el sistema","👥","raro",25,A),
    _l("gestion_usuarios","usr_a5","50 usuarios registrados","50 usuarios en el sistema","👨‍👩‍👧‍👦","raro",35,A),
    _l("gestion_usuarios","usr_a6","Gran comunidad","100 usuarios en el sistema","🌟","epico",65,A),
    _l("gestion_usuarios","usr_a7","Plataforma masiva","500 usuarios en el sistema","🏆","legendario",130,A),
]

# ══════════════════════════════════════════════════════
# LISTA COMPLETA — 231 logros
# ══════════════════════════════════════════════════════
...
def _tiene_foto(usuario: dict) -> bool:
    img = usuario.get("imagen_url") or ""
    return bool(img) and "default_icon_profile" not in img
...
def _perfil_completo(usuario: dict) -> bool:
    ...
    for c in campos:
        v = usuario.get(c)
        if not v or (c == "imagen_url" and "default_icon_profile" in str(v)):
            return False
    return True
...
def verificar_y_otorgar(cedula: str, contexto: dict | None = None) -> list[dict]:
    """
    Verifica condiciones de logros y otorga los nuevos.
    El contexto puede incluir:
      tipo        : 'login' | 'compra' | 'comentario' | 'mensaje_privado' |
                    'perfil' | 'visita' | 'accion'
      modulo      : nombre del módulo (para visitas)
      visit_count : int  (localStorage visits, desde JS)
      _rol        : rol inyectado por el controlador de sesión
      accion      : nombre de la acción (crear_producto, editar_producto, etc.)
      foto_chat   : bool
      repite_producto   : bool
      num_productos_carrito : int
      valor_carrito         : float
    ...
    # Estadísticas del sistema (admin/vendedor)
    sis: dict = {}
    ...
    dia_semana  = datetime.now(timezone.utc).weekday()  # 0=lunes, 6=domingo
    ...
    if es_visita and modulo_visita == "inicio":
        _chequear("ini_a4", visit_count >= 7)
        _chequear("ini_a5", visit_count >= 30)
        _chequear("ini_a7", visit_count >= 100)
    ...
    if es_visita and modulo_visita == "catalogo":
        ...
        _chequear("cat_v5", visit_count >= 60)
        _chequear("cat_v6", visit_count >= 100)
        _chequear("cat_v7", visit_count >= 200)
    ...
    # Contexto carrito (cuando se añade/modifica)
    ...
    # ══════════════════════════════════════════════════
    # MÓDULO 4 — ZONA DE PAGOS
    # ══════════════════════════════════════════════════
    # Cliente: basado en total_pedidos
    ...
    # Vendedor/Admin: visitas + sistema gastado
    ...
    _chequear("pago_a7", total_gastado >= 100_000)

    # Adicionales contextuales compra
    if es_compra:
        if contexto.get("repite_producto"):
            _chequear("prod_c2", True)
        _chequear("fin_semana_compra", dia_semana in (5, 6))  # legacy key (si existiera)

    # ══════════════════════════════════════════════════
    # MÓDULO 5 — SUGERENCIAS
    # ══════════════════════════════════════════════════
    ...
    _chequear("prf_c5", _tiene_foto(usuario))
    ...
    _chequear("prf_v4", _tiene_foto(usuario))
    ...
    _chequear("prf_a4", _tiene_foto(usuario))
    ...
    _chequear("fac_c6", total_gastado >= 20_000)
    _chequear("fac_c7", total_gastado >= 500_000)
    # Vendedor/Admin: visitas + sistema facturas
    ...
    # ══════════════════════════════════════════════════
    # MÓDULO 9 — GESTIÓN DE PRODUCTOS
    # ══════════════════════════════════════════════════
    # Clientes (exploración / variedad de compras)
    ...
    if es_visita and modulo_visita == "gestion_productos":
        ...
        _chequear("prod_v4", visit_count >= 30)
        _chequear("prod_v5", visit_count >= 60)
        _chequear("prod_v7", visit_count >= 100)
    ...
    if es_visita and modulo_visita == "publicidad":
        ...
        _chequear("pub_c6", visit_count >= 50)
        _chequear("pub_c7", visit_count >= 100)
        _chequear("pub_v2", visit_count >= 3)
        _chequear("pub_v3", visit_count >= 10)
        _chequear("pub_v4", visit_count >= 30)
        _chequear("pub_v5", visit_count >= 60)
        _chequear("pub_v7", visit_count >= 100)
    ...
    # Vendedores: tiempo + sistema usuarios
    ...
    # Admins: visitas + sistema usuarios
